...
```
<a href="#BackToTop"><img src='https://img.shields.io/badge/Back to Top-&#x21A9-green'></a>
...
ax1.pie(games_genre,
        labels=list(games_genre.index),
        colors=color_palette('pastel'),
        autopct='%.0f%%',
        pctdistance=0.8)

ax2.pie(sales_genre,
        labels=list(sales_genre.index),
        colors=color_palette('pastel'),
        autopct='%.0f%%',
        pctdistance=0.8)
...
Интерактивные графики plotly доступны в [отдельном ноутбуке](https://github.com/idrv/portfolio-rus/tree/main/ComputerGamesFeaturesSalesConnection/ComputerGamesFeaturesSalesConnection_plotly.ipynb.
...
def user_profile(parameter, chart_title="Define the chart title!"):
    ...
    for region, sales in regions.items():
        ...
        ax.set(title=region)
        ax.pie(pivot_sales_proc,
               labels=list(pivot_sales_proc.index),
               colors=color_palette('pastel'),
               autopct='%.0f%%',
               pctdistance=0.8)
        n += 1
